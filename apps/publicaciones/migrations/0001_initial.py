    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen', models.ImageField(default='categorias/album_default.png', null=True, upload_to='categorias')),
            ],
        ),
        migrations.CreateModel(
            name='Publicaciones',
            fields=[
                ...
                ('categoria', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='publicaciones.categoria')),
            ],
            options={
                'ordering': ('-publicado',),
            },
